...
export class PaisComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.paisService
      ...
      .subscribe(
        (res: HttpResponse<IPais[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPais(): void {
    this.eventSubscriber = this.eventManager.subscribe('paisListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPais[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
