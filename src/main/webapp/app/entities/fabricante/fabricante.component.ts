...
export class FabricanteComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.fabricanteService
      ...
      .subscribe(
        (res: HttpResponse<IFabricante[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInFabricantes(): void {
    this.eventSubscriber = this.eventManager.subscribe('fabricanteListModification', () => this.loadPage());
  }
