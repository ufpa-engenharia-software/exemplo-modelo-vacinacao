...
export class VacinaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.vacinaService
      ...
      .subscribe(
        (res: HttpResponse<IVacina[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInVacinas(): void {
    this.eventSubscriber = this.eventManager.subscribe('vacinaListModification', () => this.loadPage());
  }
