...
export class VacinacaoPessoaUpdateComponent implements OnInit {
  ...
  updateForm(vacinacaoPessoa: IVacinacaoPessoa): void {
    this.editForm.patchValue({
      ...
      codigoProfissional: vacinacaoPessoa.codigoProfissional,
      pessoaId: vacinacaoPessoa.pessoaId,
      vacinaId: vacinacaoPessoa.vacinaId,
      fabricanteId: vacinacaoPessoa.fabricanteId,
    });
  }
  ...
  private createFromForm(): IVacinacaoPessoa {
    return {
      ...
      codigoProfissional: this.editForm.get(['codigoProfissional'])!.value,
      pessoaId: this.editForm.get(['pessoaId'])!.value,
      vacinaId: this.editForm.get(['vacinaId'])!.value,
      fabricanteId: this.editForm.get(['fabricanteId'])!.value,
    };
  }
