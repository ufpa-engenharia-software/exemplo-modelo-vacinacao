...
export class DoencaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.doencaService
      ...
      .subscribe(
        (res: HttpResponse<IDoenca[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDoencas(): void {
    this.eventSubscriber = this.eventManager.subscribe('doencaListModification', () => this.loadPage());
  }
